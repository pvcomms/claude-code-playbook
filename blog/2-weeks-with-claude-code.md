...
Everything is at [github.com/paramxclaudedev/claude-code-playbook](https://github.com/paramxclaudedev/claude-code-playbook).

One command to bootstrap: `npx @paramxclaudedev/setup`
