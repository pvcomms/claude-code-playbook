  ...
  return (
    ...
    >
      <div style={{ marginBottom: "48px" }}>
        ...
        >
          The CLI installer copies all 11 skills into{" "}
        ...
        {[
          {
            ...
            desc: "11 SKILL.md files cloned into ~/.claude/skills/",
          },
          {
            step: "02",
            title: "Hooks written",
      ...
      >
        ...
        <a
          href="https://github.com/paramxclaudedev/claude-code-playbook/blob/main/blog/2-weeks-with-claude-code.md"
          target="_blank"
