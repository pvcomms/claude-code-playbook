  ...
  return (
    ...
    >
      <div style={{ marginBottom: "56px" }}>
        ...
        >
          Unified in a pnpm monorepo. Shared TS types, shared test harness,
          shared CI. Add one or all four.
        </p>
      </div>
      ...
      <pre style={{ marginTop: "32px" }}>
        {`# Install all 4
pnpm add @paramxclaudedev/mcp-whoop \\
         @paramxclaudedev/mcp-spaceship \\
         @paramxclaudedev/mcp-vercel \\
         @paramxclaudedev/mcp-hooks`}
      </pre>
    </section>
  );
}
