...
11 installable Claude Code skill modules. Each is a SKILL.md file that loads into
...
| `frontend-design`         | any UI build                                  | Production-grade frontend with distinctive design                 |
